...
public class RXTXSerialPortImpl implements ISerialPort
{
  ...
  boolean isOpen=false;
	...
	public RXTXSerialPortImpl(int number, int baudRate){
		this(number, baudRate, 8, false, 1);
	}
	public RXTXSerialPortImpl(int number, int baudRate, int bits, boolean parity, int stopBits){
	...
	public void initPort(int number, int baudRate, int bits, boolean parity, int stopBits){
	    ...
	    try
	    {
	      ...
	      sPort = (gnu.io.SerialPort)portId.open("Waba", 1000);
