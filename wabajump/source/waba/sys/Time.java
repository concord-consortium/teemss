...
public class Time
{
   ...
   public Time()
   {
      DateTime oNowTM=new DateTime();

      Palm.TimSecondsToDateTime(Palm.TimGetSeconds(), oNowTM);
      this.year=oNowTM.year;
      this.month=oNowTM.month;
      this.day=oNowTM.day;
      this.hour=oNowTM.hour;
      this.minute=oNowTM.minute;
      this.second=oNowTM.second;
      this.millis=Vm.getTimeStamp();
   }
