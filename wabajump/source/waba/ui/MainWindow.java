...
{
   palmos.Event oEvent=new palmos.Event();

   oEvent.eType=palmos.Event.appStopEvent;
   //where would exitCode go?
   Palm.EvtAddEventToQueue(oEvent);
}
