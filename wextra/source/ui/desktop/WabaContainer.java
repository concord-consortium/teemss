...
public class WabaContainer extends Container implements ISurface

{

WinCanvas1 _winCanvas;
...
public WabaContainer()
	...
	jWindow =new java.awt.Dialog((java.awt.Frame)waba.applet.Applet.currentApplet.getParent());
	jWindow.setLayout(new java.awt.BorderLayout());
	jWindow.setSize(width, height);
	jWindow.show();
	_winCanvas = new WinCanvas1(this);
