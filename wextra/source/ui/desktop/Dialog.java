...
public class Dialog extends waba.ui.Window{
	...
	protected DialogListener	listener;//dima
	...
	public static Dialog showConfirmDialog(DialogListener l,
										   String title,String message,
										   String []buttonTitles,int messageType)
	{
	...
	public static Dialog showMessageDialog(DialogListener l,String title,String message,
										   String buttonTitle,int messageType)
	{
		Dialog d = new Dialog(title);
		waba.fx.FontMetrics fm = d.getFontMetrics(d.getFont());
		int messageWidth 	= fm.getTextWidth(message);
	...
	public static Dialog showInputDialog(DialogListener l, String title, String message,
										 String []buttonTitles,int messageType)
	{
		return showInputDialog(l,title,message,buttonTitles,messageType,null,null);
	}
	public static Dialog showInputDialog(DialogListener l,String title, String message,
										 String []buttonTitles,int messageType,String []choices)
	{
