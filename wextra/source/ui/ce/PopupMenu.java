...
*				This class was derived from extra.ui.List class
...
public class PopupMenu extends Control implements extra.ui.PreferredSize

{
  ...
  public PopupMenu(String[] options)
  ...
  public PopupMenu(Vector options)
...

  {
...

    {
		...
		if (parent instanceof extra.ui.RelativeContainer)

		((extra.ui.RelativeContainer)parent).layout();
        ...
        case PenEvent.PEN_UP:
...

          {
			...
			if(listener != null){
				...
				listener.actionPerformed(new ActionEvent(this,this,(String)options.get(selected)));
