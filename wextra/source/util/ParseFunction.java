...
//                System.out.println("After Reordering:");
   ...
   */
        public float getResult(float x, float y, float z)/*dima 
                                                    throws Exception */{
   ...
   * @return solution of the function
   */
        public float getResult(float x, float y) /*dima 
                                                    throws Exception */{
   ...
   * @return solution of the function
   */
        public float getResult(float x)/*dima throws Exception */{
   ...
   */
        public float getResult()/*dima throws Exception */{
   ...
   */
        public float[] getResults(int n, float x[])/*dima  throws Exception */{
...
*/
   ...
   */
        public float[] getResults(int n, float x[], float y[]) 
                                   /*dima  throws Exception */{
...
*/
   ...
   */
        public float[] getResults(int n, float x[], float y[], float z[]) 
                                    /* dima throws Exception */{
...
*/
  ...
  */
        private float evaluate(Node node)/*dima throws Exception */{
        	float value = 0.0f;
...
*/
		    ...
		    case Node.GROUP:
        	    ...
        	    case Node.INDEPENDENT:
        	                    ...
        	                    break;
        	    default:
  //dima      	              throw new Exception("evaluate: Unknown type!");
  ...
  */        
        private float evaluateOp(Node node)/*dima throws Exception */{
        	  float value = 0.0f;
        	  ...
        	  switch (node.op)  {
        	  	...
        	  	case MULTIPLY:
        	 	           ...
        	 	           break;
        	  	case POWER:
        	 	           value = Maths.pow(evaluate(node.left),
        	 	                            evaluate(node.right));
        	 	           break;
        	 	default:
/*
...
*/
  ...
  */ 
        private float evaluateIntrinsic(Node node)/*dima throws Exception */{
        	  float value = 0.0f;
        	  ...
        	  switch (node.op)  {
        	  	...
        	  	case SIN:
        	 	           value = Maths.sin(evaluate(node.left));
        	 	           break;
        	  	case COS:
        	 	           value = Maths.cos(evaluate(node.left));
        	 	           break;
        	  	case TAN:
        	 	           value = Maths.tan(evaluate(node.left));
        	 	           break;
  /*DIMA
        	  	case ASIN:
  ...
  */
        	  	case LOG:
        	 	           value = Maths.log(evaluate(node.left));
        	 	           break;
			case SQRT: 
                                   value = Maths.sqrt(evaluate(node.left));
                                   break;
			...
			case LOG10:
                                   value = Maths.log(evaluate(node.left))/
                                           Maths.E;
                        case EXP:
                                   value = Maths.exp(evaluate(node.left));
                                   break;
/*
		        case J0:
...
*/
	  	        case ATAN2:
                                   value = Maths.atan2(evaluate(node.left),
                                                      evaluate(node.right));
                                   break;
/*
	  	        case JN:
