...
// Date: 16 Jan 1998
//
// made maximum program size larger, kcbPrcMax now 1M
// Scott Cytacki (scott@concord.org)
// Date: 14 Feb 2002
//
...
long gcbPrc;
FourCC gfcAppId = MAKE4CC('T','E','M','P');
...
bool LayoutPrc(char *pszFilename, char *pszAppName)
{
    ...
    ulT = ntohl(MAKE4CC('P','i','l','a'));
    memcpy(gpbPrc + 28, &ulT, 4);
