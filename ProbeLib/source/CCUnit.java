...
public  static CCUnit 	[]unitTable = 
	{
		...
		new CCUnit("kilogram-force","kgf",true,UNIT_CAT_FORCE,UNIT_CODE_KGF,UNIT_CODE_NEWTON,1,1,-2,0,0,0,0,0,0,9.80665f,0.0f,false,false),
		new CCUnit("pound-force","lbf",true,UNIT_CAT_FORCE,UNIT_CODE_LBF,UNIT_CODE_NEWTON,1,1,-2,0,0,0,0,0,0,4.448222f,0.0f,false,false),
