...
public class ProbeManager extends Object
{
    ...
    public final static int PROBE_STOPPED = 4;
    public final static int PROBE_DELE = 5;
	...
	probeInfo[0] = new ProbeInfo(ProbeInfo.SIZE, new Integer(INFO_SIZE));
	probeInfo[1] = new ProbeInfo(ProbeInfo.NUM, new Integer(1));
	...
	response = PROBE_STOPPED;
	msg = "You already stopped the probe";
	return true;
    }
